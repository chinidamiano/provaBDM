...
for batch in human_batches:
    dfs[batch] = pd.read_pickle("./Preprocessed_Data/Human/"+batch+"_geno.p")
...
plt.savefig("./output/2-First_part/figures/FigureP1.pdf")
...
for i,batch in enumerate(human_batches):
    ...
    plt.yticks(yticks,["$10^{-%1.1f}$"%i for i in yticks],fontsize=14)
    plt.subplots_adjust(wspace=0.3)
plt.savefig("./output/2-First_part/figures/FigureP2.pdf")
...
plt.savefig("./output/2-First_part/figures/Figure1a.pdf")
#plt.show()
...
for b,n in enumerate(batch_sizes[:-1]):
    ...
    ax.text(nn-n/2,N+1,"Batch"+str(b+1),rotation=0,fontsize=13.5,color="black",horizontalalignment="center")
ax.text(N-3,N+1,"B4",rotation=0,fontsize=13.5,color="black",horizontalalignment="center")
plt.savefig("./output/2-First_part/figures/Figure1b.pdf")
#plt.show()
...
plt.savefig("./output/2-First_part/figures/Figure1c.pdf")
#plt.show()

n_geno.to_pickle("./output/2-First_part//batch123456_geno.p")
pheno.to_pickle("./output/2-First_part/batch123456_pheno.p")
